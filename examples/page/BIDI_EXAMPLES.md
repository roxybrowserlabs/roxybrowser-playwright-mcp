...
### 1. `launch-firefox-bidi.mjs` - 连接 Firefox

这个示例展示如何连接到已运行的 Firefox 浏览器并使用 BiDi 协议进行自动化。
...
const browser = await firefox.connect("ws://127.0.0.1:9222/session");
...
# 更新环境变量
export ROXY_BIDI_ENDPOINT=ws://127.0.0.1:9223/session
```
